# Generated by Django 5.0.7 on 2024-07-22 07:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.servicecompany', verbose_name='Сервисная компания')),
                ('steering_axle_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.steeringaxlemodel', verbose_name='Модель рулевого моста')),
                ('transmission_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.transmissionmodel', verbose_name='Модель трансмиссии')),
            ],
        ),
        migrations.CreateModel(
            name='Maintenance',
